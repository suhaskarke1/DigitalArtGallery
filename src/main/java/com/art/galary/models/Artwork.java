package com.art.galary.models;

import java.util.List;

public class Artwork {
    private Integer id;  // Change from int to Integer to support null
    ...
    public Artwork(Integer id, String title, String description, String category, String label, int price, int likes, String imgUrl, int owner_id) {
        this.id = id;
        this.title = title;
